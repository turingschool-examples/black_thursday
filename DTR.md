...
* How would you describe your work style/POM cadence?
...
* How will we overcome obstacles?
  ...
  * Group collaboration - see notes on dealing with issues in the project, below

* What do you need (resources, environment, communication) to do your best work?

  * Sleep!
  * Independent work time for non-project Turing work.
...
* Quarantine is tough, so it’s important to make note of our mental/emotional state when working with others. How can we make space to check in on each other’s well being, in addition to the work that needs to be done?
  ...
  * We will check in about this stuff during daily standups.
...
* Sami: Central Timezone (+1 to MST), no coding after 8pm MST (9pm CST)
* Richard: No coding after 9pm, early mornings are tough (if needed 1 hour coding the AM), 6-7pm is dinnertime
* Molly: No coding after 9pm, can code after 7:30am or so, no group time during lunch time
...
* TBD in project planning

Workflow Expectations (Git workflow/Tools/Code Review/Reviewing Pull Requests/Debugging and Problem-solving Techniques):

* Use of GitHub project manager
* Team Members will each create issues
* Group will create Milestones and issues will be organized into those Milestones
...
Project work time 1-4pm: Group will meet to begin planning project outline. 
