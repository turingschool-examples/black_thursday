...
class MerchantTest < Minitest::Test
  ...
  def test_can_be_initialized_with_attributes
    ...
    assert_equal Time.parse("2007-06-25"), me_1.created_at
    assert_equal Time.parse("2015-09-09"), me_1.updated_at
  ...
  def test_can_be_initialized_with_other_attributes
    ...
    assert_equal Time.parse("2007-09-10"), me_2.created_at
    assert_equal Time.parse("2015-10-11"), me_2.updated_at
