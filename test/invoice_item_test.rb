...
class InvoiceItemTest < Minitest::Test
  ...
  def test_that_it_has_a_unit_price_given_a_big_decimal
    ii = InvoiceItem.new({ id: 11, item_id: 263532898, invoice_id: 2, quantity: 3, unit_price: BigDecimal.new(309.49, 4), created_at: "2012-03-27 14:54:09 UTC", updated_at: "2012-03-27 14:54:09 UTC" })

    assert_equal BigDecimal(309.49, 4), ii.unit_price
  end
