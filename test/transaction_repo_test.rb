...
class TransactionRepoTest < Minitest::Test
  ...
  def test_it_can_find_invoice_by_id
    ...
    transaction_repo = TransactionRepository.new(se, "./data/transactions.csv")
    results = transaction_repo.find_invoice_by_invoice_id(1)

    assert_equal 1, results.id
    assert_equal 12335938, results.merchant_id
  end
end
