...
class TransactionRepoTest < MiniTest::Test
  ...
  def test_transaction_repo_can_find_by_id
    expected = @se.transactions.find_by_id(2)
    expect_nil = @se.transactions.find_by_id(000)
  ...
  expected = @se.transactions.find_all_by_credit_card_number("4848466917766329")
  ...
  expected = @se.transactions.find_all_by_result(:success)
  ...
  @se.transactions.update(4158, attributes)
  expected = @se.transactions.find_by_id(4158)
