...
class ItemRepositoryTest < Minitest::Test
  ...
  def test_find_all_by_description_returns_an_array
    ...
    assert_equal [], ir.find_all_by_description("AHAHAHAHAHAHAHAHAHAH")
  end
  ...
  def test_it_can_find_multiple_items_by_part_of_a_description
    ...
    assert_equal 2, ir.find_all_by_description("blue").length
  end
  ...
  def test_it_can_find_multiple_items_by_a_range_of_prices
    ...
    assert_equal 3, ir.find_all_by_price_in_range(1200..1350).length
  end
