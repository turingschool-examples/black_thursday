...
class MerchantRepositoryTest < Minitest::Test
  ...
  def test_find_by_id_nil
    ...
    assert_nil merch.find_by_id(39472)
  end
  ...
  def test_find_specific_id
    ...
    assert_instance_of Merchant, merch.find_by_id(12334115)
  end
  ...
  def test_find_by_name_nil
    ...
    assert_nil merch.find_by_name("Gerald")
  end
  ...
  def test_find_specific_name
    ...
    assert_instance_of Merchant, merch.find_by_name(name)
  end
  ...
  def test_find_all_by_name
    ...
    assert_equal [], merch.find_all_by_name(fragment)
  end
  ...
  def test_find_all_by_name_specific_name
    ...
    assert_equal 1, merch.find_all_by_name(fragment).count
  end
  ...
  def test_find_all_by_name_specific_name_again
    ...
    assert_equal 2, merch.find_all_by_name(fragment).count
  end
end
