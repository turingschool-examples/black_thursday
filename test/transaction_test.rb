...
class TransactionTest < Minitest::Test
  def set_up
    transaction_info = ({:id => "1", :invoice_id => "2179", :credit_card_number => "4068631943231470", :credit_card_expiration_date => "0217", :result => "success", :created_at => "2012-02-26 20:56:56 UTC", :updated_at => "2012-02-26 20:56:56 UTC"})
