...
class InvoiceAnalystTest < Minitest::Test
    ...
    def test_average_invoices_per_merchant
        assert_equal 15, @sales_analyst.average_invoices_per_merchant
    end

    def test_it_can_find_the_std_per_deviation
        assert_equal 12.96, @sales_analyst.average_invoices_per_merchant_standard_deviation
    end

    def test_it_can_find_the_top_merchants
       assert_instance_of Array, @sales_analyst.top_merchants_by_invoice_count
       assert_equal 12334135, @sales_analyst.top_merchants_by_invoice_count[0].id
    end
