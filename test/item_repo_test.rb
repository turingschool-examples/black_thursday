...
class ItemRepoTest < Minitest::Test
  ...
  def test_it_can_find_item_by_id
    item = item_repo.find_by_id(263_396_013)
    assert_equal 263_396_013, item.id
  end
  ...
  def test_it_can_find_all_items_with_description
    ...
    items_array = items.map(&:id)

    assert_equal [263_396_013, 263_396_011], items_array
  end
  ...
  def test_it_can_find_all_by_price
    ...
    assert_equal [263_395_721, 263_395_729], items_array
  end
  ...
  def test_find_all_with_price_in_range
    ...
    assert_equal [263_395_237, 263_395_617,
                  263_395_721, 263_395_239,
                  263_395_619, 263_395_729], items_array
  end

  def test_it_finds_all_items_with_merchant_id
    merchant_id = 12_334_185
    items = item_repo.find_all_by_merchant_id(merchant_id)

    items_array = items.map(&:id)

    assert_equal [263_395_617, 263_395_721,
                  263_396_013, 263_395_619,
                  263_395_729, 263_396_011], items_array
  end

  def test_it_finds_merchant_by_merchant_id
    merchant_id = 263_395_617
    parent.expect(:find_merchant_by_merchant_id, 'merchant', [263_395_617])
  ...
  def test_it_can_find_item_with_max_id
    ...
    assert_equal 263_396_013, max_id
  end
