...
class SalesAnalystTest < Minitest::Test
  ...
  def test_average_price_for_merchant_returns_average_price_for_the_item
    assert_equal BigDecimal, @SalesAnalyst.average_item_price_for_merchant(12334159)
  end

  def test_average_price_per_merchant_sums_prices_across_all_merchants

    assert_equal BigDecimal, @SalesAnalyst.average_average_price_per_merchant
  end
