...
class SalesAnalystTest < Minitest::Test
  ...
  def test_average_item_price_for_merchant
    assert_equal 16.66, @sales_analyst.average_item_price_for_merchant(12_334_105)
  end
  ...
  def test_it_can_return_revenue_by_date
    assert_equal 21_067.77, @sales_analyst.total_revenue_by_date(Time.parse('2009-02-07'))
  end

  def test_it_can_return_top_revenue_earners
    assert_equal 12_334_634, @sales_analyst.top_revenue_earners.first.id
  end
  ...
  def test_revenue_by_merchant_returns_big_decimal_for_given_merchant
    assert_instance_of BigDecimal, @sales_analyst.revenue_by_merchant(12_334_194)
  end

  def test_item_quantity_for_merchant
    assert_equal 40, @sales_analyst.item_quantity_for_merchant(12_334_194).length
  end
  ...
  def test_return_merchant_invoice_ids
    ...
    assert_equal test_ids, @sales_analyst.return_merchant_invoice_ids(12_334_194)
  end

  def test_most_sold_item_by_id_for_merchant
    assert_equal [263_545_484, 263_521_128, 263_526_484], @sales_analyst.most_sold_item_by_id_for_merchant(12_334_194)
  end

  def test_most_sold_item_for_merchant
    assert_equal 3, @sales_analyst.most_sold_item_for_merchant(12_334_194).length
  end

  def test_item_value_totals
    assert_equal 40, @sales_analyst.item_value_totals(12_334_194).length
  end

  def test_best_item_for_merchant
    assert_equal 24_995.0, @sales_analyst.best_item_for_merchant(12_334_194).unit_price_to_dollars
  end
end
