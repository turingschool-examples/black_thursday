...
class SalesEngine
  ...
  def initialize(item_csv_location, merchant_csv_location, invoice_csv_location, invoice_item_csv_location)
  ...
  def self.from_csv(csv_hash)
    ...
    SalesEngine.new(item_csv_location, merchant_csv_location, invoice_csv_location, invoice_item_csv_location)
  end
