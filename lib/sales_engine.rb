...
class SalesEngine
  ...
  attr_accessor :merchants, :items, :invoices, :invoice_items, :analyst

  def initialize(merchant_array, item_array, invoice_array, invoice_item_array)
    ...
    @analyst = SalesAnalyst.new(@merchants, @items, @invoices, @invoice_items)
  end
  ...
  def self.from_csv(hash)
    ...
    new(merchant_array, item_array, invoice_array, invoice_item_array)
  end
