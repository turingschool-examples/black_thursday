...
RSpec.describe TransactionRepository do
  ...
  it 'find_all_by_invoice_id' do
    ...
    result2 = @engine.transactions.find_all_by_invoice_id(9_449_495_949_959_495_954)
  ...
  it 'create' do
    data = {
      invoice_id: 10_001,
      credit_card_number: 1_111_111_111_111_111,
  ...
  it 'update' do
    ...
    expect(@engine.transactions.all.first.credit_card_number).to eq(1_111_111_111_111_111)
