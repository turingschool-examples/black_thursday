...
RSpec.describe TransactionRepository do
  ...
  it 'can find by ID, otherwise return nil' do
    ...
    expect(engine.transactions.find_by_id(99_999_999)).to eq(nil)
  end

  it 'can find all by invoice id' do
    expect(engine.transactions.find_all_by_invoice_id(2179)).to eq([engine.transactions.all[0],
                                                                    engine.transactions.all[766]])
    expect(engine.transactions.find_all_by_invoice_id(99_999_999)).to eq([])
