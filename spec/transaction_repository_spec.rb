...
RSpec.describe TransactionRepository do
  ...
  context 'Methods' do
    ...
    it '#find_all_by_invoice_id' do
      expect(@tr.find_all_by_invoice_id(2179)).to be_an Array
      expect(@tr.find_all_by_invoice_id(2179)[0].id).to eq 1
    ...
    it '#update' do
      ...
      expect(updated_transaction.result).to be_a Symbol
