...
RSpec.describe SalesAnalyst do
  ...
  describe '#find_customer_by_id' do
    xit 'returns a Customer object matching given id' do
  ...
  describe '#customer_spent' do
    xit 'returns how much a customer has spent' do
  ...
  describe '#customer_invoices' do
    xit "returns an array of a customer's invoices" do
  ...
  describe '#invoice_revenue' do
    xit 'returns the revenue generated by that invoice' do
      expect(sales_analyst.invoice_revenue(54)).to eq 3095.31
    end
  end

  describe '#invoice_items_by_invoice_id' do
    xit 'returns an array of all invoice_items matching invoice id' do
