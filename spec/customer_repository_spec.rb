...
RSpec.describe CustomerRepository do
  ...
  it 'finds all by first name -if first name does not exist returns nil' do
    ...
    expect(engine.customers.find_all_by_first_name('Lisa')).to eq([engine.customers.all[60], engine.customers.all[66],
                                                                   engine.customers.all[599], engine.customers.all[646]])
    expect(engine.customers.find_all_by_first_name('oe')).to eq([engine.customers.all[0], engine.customers.all[191],
                                                                 engine.customers.all[308], engine.customers.all[446], engine.customers.all[504], engine.customers.all[567], engine.customers.all[588], engine.customers.all[823]])
  end
