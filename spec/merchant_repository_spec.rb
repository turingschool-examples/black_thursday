...
RSpec.describe do
  describe MerchantRepository do
    it 'exists' do
      ...
      merch_repo = MerchantRepository.new('./spec/fixtures/merchant_mocks_spec.csv', mock_engine)
    ...
    it 'has attributes' do
      ...
      expect(merch_repo.file_path).to eq('./spec/fixtures/merchant_mocks_spec.csv')
