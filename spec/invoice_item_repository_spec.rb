...
RSpec.describe InvoiceItemRepository do
  ...
  before :each do
  @invoice_item_1 = InvoiceItem.new({ id: 6, item_id: 7, invoice_id: 8, quantity: 1, unit_price: 10.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC" })
  @invoice_item_2 = InvoiceItem.new({ id: 7, item_id: 8, invoice_id: 9, quantity: 2, unit_price: 9.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC"})
  @invoice_item_3 = InvoiceItem.new({ id: 8, item_id: 9, invoice_id: 10, quantity: 3, unit_price: 3.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC"})
  ...
  it 'can update invoice_items' do
    ...
    invoice_item_2 = InvoiceItem.new({ id: 7, item_id: 8, invoice_id: 9, quantity: 2, unit_price: 9.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC"})
    invoice_item_3 = InvoiceItem.new({ id: 8, item_id: 9, invoice_id: 10, quantity: 3, unit_price: 3.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC"})
    invoice_item_4 = InvoiceItem.new({ id: 9, item_id: 10, invoice_id: 11, quantity: 4, unit_price: 4.99 , created_at: "2022-02-25 17:49:56.871723", updated_at: "2022-02-26 00:51:07 UTC"})
